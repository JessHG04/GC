...
int main(int argc, char* argv[])
{
    ...
    TPrimitiva *semaforo = new TPrimitiva(8, SEMAFORO_ID);
    TPrimitiva *senyal = new TPrimitiva(9, SENYAL_ID);
    TPrimitiva *suelo = new TPrimitiva(10, SUELO_ID);
